...
export class StreamerService {
  ...
  private readonly baseUrlList = `https://api.themoviedb.org/4/list/1?page=1&api_key=${this.apiKey}`;
  ...
  public list() :Observable<Results[]>{
    ...
    return this.http.get<List>(this.baseUrlList).pipe(map((res: List) => res.results));
  }
}
